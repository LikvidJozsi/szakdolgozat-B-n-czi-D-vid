...
\include{content/neuralnet}

\include{content/explanation}

\include{content/lime}
%sok szép ábra

\chapter{Gyakorlati alkalmazás/esettanulmányok}\label{ch:example}
\section{Ateizmus adathalmaz}
\section{Genetikai adathalmaz}
\section{Modell optimalizálás folyamata}
%sok szép ábra
\section{Magyarázat generálás folyamata}
\section{Magyarázat értékelése}

\chapter{Különböző magyarázat modellek}
%ha sikerül
\section{Döntési fa lehetősége}
\section{Implementáció}
\section{Értékelése Genetikai adathalmazon}
